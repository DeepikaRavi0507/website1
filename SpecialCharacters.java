...
public class SpecialCharacters {
    ...
    public static void main(String[] args) {
        String inputFilePath = "C:\\Users\\deepikarr\\IdeaProjects\\Source\\input.txt";   // Path to input text file
        String outputFilePath = "C:\\Users\\deepikarr\\IdeaProjects\\Source\\output.txt"; // Path to output text file
